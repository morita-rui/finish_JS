...
style.textContent = `
    body {
        text-align: center;
        margin-top: 120px;
        background-color:rgb(216, 249, 231); 
    }
    .ty {
        margin: 0;
    }
...
function updateTimer() {
    ...
    const remainingTime = 40 - elapsed;
...
function reGame() {
    ...
    startTime = new Date(new Date() - (40 - parseInt(document.getElementById('downTimer').innerText.split(' ')[1])) * 1000);
    timerInterval = setInterval(updateTimer, 1000);
}
